...
echo "    http://localhost:$PORT/overall_presentations/01_sovereign_architecture_presentation/web_deck/"
echo ""
echo " 2. Матрица Ценности для Стейкхолдеров (15 слайдов):"
echo "    http://localhost:$PORT/overall_presentations/02_stakeholders_benefits_presentation/web_deck/"
echo ""
echo " [Детальные презентации по стейкхолдерам / Detailed Series]:"
echo " 3. Граждане и Домохозяйства:"
echo "    http://localhost:$PORT/detailed_overall_impact_presentations/01_citizens_presentation/web_deck/"
echo "========================================================="
