...
1. **Единое локальное реляционное пространство:** Каждое приложение является владельцем своего хранилища (`%Repository`), но данные физически размещаются в единой высокопроизводительной локальной базе SQLite на устройстве гражданина.
...
3. **Семейный контур поручений (`%Family`):** Задачи внутри семьи синхронизируются напрямую между устройствами Листьями без отправки расписания семьи на сторонние облачные серверы.
