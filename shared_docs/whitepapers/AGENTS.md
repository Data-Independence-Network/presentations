...
| **06** | [`06_cbr_smart_contracts_fsm_whitepaper.md`](file:///Users/parents/Documents/presentations/shared_docs/whitepapers/06_cbr_smart_contracts_fsm_whitepaper.md) | `06_cbr_smart_contracts_fsm_whitepaper.pdf` | **Смарт-контракты ЦВЦБ для Банка России:** Ответ на консультационный доклад ЦБ РФ по ПКСК: детерминированные автоматы (FSM) $O(1)$, Zero-PII, бестерминальность/IOU, Collaborative Apps, ответы на 7 вопросов ЦБ и 3-летний план. | 15 стр. |
