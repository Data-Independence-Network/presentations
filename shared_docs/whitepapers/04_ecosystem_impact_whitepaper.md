...
1. **Фаза 1 — Теневой контур (Параллельная репликация):** Развертывание шлюзов «Ветка» рядом с существующими базами данных. Данные дублируются в автономные доверенные репозитории без изменения клиентских приложений.
