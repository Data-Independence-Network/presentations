...
### 2.4. Восточные модели долевого партнерского финансирования (PLS): Альтернатива ссудному проценту и долговой кабале
- **Принцип справедливого разделения рисков (Profit-and-Loss Sharing, PLS):** В русле Федерального закона № 377-ФЗ о партнерском финансировании и многовековых восточных традиций инвестор разделяет реальные предпринимательские риски с исполнителем. Доход инвестора формируется как доля в фактически созданной чистой прибыли ($\alpha \cdot \Pi$), а не как фиксированный процент, начисляемый независимо от исхода дела.
- **Смарт-Мудараба (Mudarabah):** Трастовое партнерство пассивного инвестора (Рабб аль-мал) и предпринимателя (Мудариб). При объективном убытке инвестор теряет капитал, а предприниматель — время и труд (без долговой ямы и конфискации личного имущества). При этом недобросовестность (халатность / Tafrit) строго пресекается оракулами TAPO и арбитражем «КубГолоса».
- **Убывающая Мушарака (Diminishing Musharakah):** Долевое соинвестирование в покупку оборудования и станков для артелей и МСП. Предприниматель постепенно выкупает долю инвестора через транши в Цифровом рубле с одновременным пропорциональным снижением платы за аренду оставшейся доли, без кабальных кредитных переплат.
- **Солидарная взаимопомощь Такафул (Takaful):** Создание взаимных резервных фондов на районных Ветках (Табарру'), демпфирующих природные и производственные форс-мажоры с гарантированным возвратом неиспользованных излишков участникам пула.
...
* **Партнерское проектное соинвестирование (Мудараба и Убывающая Мушарака):** Артели и стартапы привлекают капитал от частных инвесторов и банков без ссудного процента по схеме разделения прибыли (PLS / 377-ФЗ). Оборудование и станки приобретаются в совместную собственность и постепенно переходят к артели по мере выкупа долей в Цифровом рубле с автоматическим сокращением арендных платежей.
...
| **4. Бизнес** | Кредитный голод МСП, долговая кабала, простой станков | B2B шеринг оборудования + рейтинг надежности + Proof-of-Delivery | Беззалоговые займы по ZK-Credit, B2B смарт-факторинг, PLS-соинвестирование (Мудараба / Мушарака) | Снижение ставок, замена кредита разделением прибыли (PLS / 377-ФЗ), выкуп станков без кабалы |
