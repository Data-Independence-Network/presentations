...
### 2. Как помогает «Забота»
* **ZK-кредитование оборотного капитала:** Предприниматель доказывает безупречную репутацию исполнения заказов через ZK-Credit Attestation и получает заем в Цифровом рубле напрямую от локальных инвесторов без залога.
...
| **4. Бизнес** | Кредитный голод МСП, простой редких станков | B2B шеринг оборудования + рейтинг надежности поставщиков | Беззалоговые P2P-займы по ZK-Credit Attestation | Снижение ставок по кредитам, защита от банкротства |
