...
> ℹ️ *Полная нормативная математическая и криптографическая спецификация с формулами объемно-взвешенной субъективной логики (VW-EBSL), ZK-нуллификаторами против одновременных дефолтов, защитой от Exit-Scam, протоколом децентрализованного суда присяжных (P2P Sortition Jury), транзитивными цепочками поручительства (Multi-Hop Transitive Trust) и межветвевыми пулами ликвидности касс взаимопомощи (ROSCA Inter-Branch Swaps) представлена в отдельном документе: [**`Sapoto_Reputation_and_Credit_System_Specification.md`**](Sapoto_Reputation_and_Credit_System_Specification.md).*
