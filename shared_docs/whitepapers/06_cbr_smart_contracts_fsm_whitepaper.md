...
flowchart TD
    subgraph UpperLayer ["ВНЕШНИЙ ИНФОРМАЦИОННЫЙ КОНТУР: ПЛАТФОРМА «ТУРБАЗА» (Zero-PII Периферия)"]
        L1["📱 <b>Устройства (Лист)</b><br/>Смартфоны и ПК бизнеса<br/>СУБД SQLite / WASM"]
        B1["⚡ <b>Районные узлы (Ветка)</b><br/>Маршрутизация дельт<br/>Вектор ГОСТ-подписей (ПЭП/НЭП/УКЭП)"]
        M1["🔗 <b>Микро-цепи сделок</b><br/>Локальные хранилища фактов<br/>Zero-PII экранирование корзин"]
    ...
    subgraph LowerLayer ["ВНУТРЕННИЙ РАСЧЕТНЫЙ КОНТУР: ЦИФРОВОЙ РУБЛЬ И ПКСК (Банк России)"]
        K1["⚙️ <b>Шлюз ПКСК: FSM O(1)</b><br/>Реестр хэшей шаблонов ЦБ<br/>Валидация вектора подписей"]
        P1["🏛️ <b>Процессинг ЦВЦБ</b><br/>Высокоскоростной клиринг<br/>Сложность O(1) без циклов"]
        W1["💰 <b>Кошельки участников</b><br/>Безусловный пересчет балансов<br/>Зачисление средств контрагентам"]
