...
# ==============================================================================
# Turbase Presentation Suite — TTS Audio Regeneration Installer (Debian/Ubuntu)
...
echo "======================================================================"
echo " 🎙️  Installing Turbase Presentation Regeneration & TTS Dependencies"
echo "======================================================================"

# 1. First run the base build software installer
echo ""
echo "[Step 1/3] Executing Base Build Software Installer..."
...
echo ""
echo "======================================================================"
echo " 🎉 Full Regeneration & TTS Environment Successfully Configured!"
echo "======================================================================"
echo " You can now synthesize new neural audio and regenerate presentations:"
echo "   npm run regen-overall"
echo "   npm run regen-overall-architecture"
echo "   npm run regen-overall-stakeholder"
