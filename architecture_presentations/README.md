...
Серия детально раскрывает устройство суверенной трехуровневой платформы прямого владения данными:
- **01. Топология и суверенитет:** Четыре ранга узлов (Лист, Ветка, Родительская Ветвь, Ствол), философия AIR, разграничение Data Plane и Control Plane.
...
- **07. Криптоконтур и экономика API:** ГОСТ Р 34.12/34.10, постквантовая криптография (PQC), Keyring, 152-ФЗ Zero-PII и микророялти 1/N.
...
| **07** | [**Выпуск 7: Криптографический контур и экономика совместного использования API**](file:///Users/parents/Documents/presentations/architecture_presentations/07_cryptography_and_api_economy/README.md) | Финальный выпуск архитектурной серии: глубокий разбор криптографического периметра по стандартам ГОСТ Р 34.12/34.11/34.10, постквантовой кри... | [`web_deck/`](file:///Users/parents/Documents/presentations/architecture_presentations/07_cryptography_and_api_economy/generated/outputs/web_deck/index.html) | [README.md](file:///Users/parents/Documents/presentations/architecture_presentations/07_cryptography_and_api_economy/README.md) |
