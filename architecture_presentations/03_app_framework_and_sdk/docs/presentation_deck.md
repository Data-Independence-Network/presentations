    ...
    <div class="content-panel">
      <div class="content-cards-stack">
        <div class="content-card border-cyan">
          ...
          <p>В следующем выпуске мы разберем <strong>Архитектуру узла «Ветка» (Branch Node)</strong>: конвейер данных высокой надежности, трехфазную цепочку PersistentQueue &rarr; ConcurrentMap &rarr; FileSystem, Time-Traveling и обслуживание общественных реестров.</p>
        </div>
        <div class="content-card">
