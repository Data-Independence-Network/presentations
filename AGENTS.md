...
10. **Strict Style Isolation & Track Decoupling Principle**:
    All presentations belong to distinct tracks and must have strictly decoupled stylesheets to prevent style bleed or regression across tracks:
    - **Universal Core (`shared_templates/deck_core/`):** Base player resets, 1920x1080 viewport framing, header controls, speaker drawer, and overview modal.
    - **Overall Master Presentations (`overall_presentations/`):** Uses self-contained stylesheets ([`docs/architecture.css`](file:///Users/parents/Documents/presentations/overall_presentations/01_sovereign_architecture_presentation/docs/architecture.css) and [`docs/stakeholders.css`](file:///Users/parents/Documents/presentations/overall_presentations/02_stakeholders_benefits_presentation/docs/stakeholders.css)) without inheriting or overriding other decks.
    - **Platform Overview Explainer Trilogy (`platform_overview/`):** Uses [`shared_templates/platform_overview_deck/`](file:///Users/parents/Documents/presentations/shared_templates/platform_overview_deck/) (`platform_overview_theme.css` + `platform_overview_components.css`).
    - **Detailed Ecosystem Series (`detailed_overall_impact_presentations/`):** Uses [`shared_templates/detailed_impact_deck/`](file:///Users/parents/Documents/presentations/shared_templates/detailed_impact_deck/).
    - **Zero-Overflow Invariant:** Any style or typography modification must be verified across all slides in Playwright (1920x1080) to ensure zero vertical overflow (`scrollHeight <= clientHeight`). Changes in one presentation must NEVER break or alter the layout of another.
