...
subtitle: "Манифест и Смена парадигмы: От платформенного монополизма к владению собственной информацией"
header_title: "ТУРБАЗА"
header_subtitle: "Манифест и Смена парадигмы"
theme: "platform_overview"
theme_class: "paradigm-shift-deck"
total_slides: 15
...
<div class="slide-content">
  <div class="slide-header">
    ...
    <p class="slide-subtitle">Владение информацией у граждан, суверенитет данных у государства вместо платформенного монополизма</p>
  </div>
    ...
    <div class="visual-panel">
      <div class="arch-blueprint-preview">
        <div class="arch-kpi-chip">
          ...
          <div class="kpi-label">Автономных хранилищ граждан и бизнеса РФ</div>
...
### Текст для диктора:
> Здравствуйте! В этой вводной серии представлена платформа «Турбаза» — национальная среда автономных хранилищ и сотрудничающих приложений.
>
> Последние двадцать лет индустрия развивалась в парадигме закрытых платформенных монополий: семейные архивы, переписка и коммерческие тайны доверялись внешним облачным серверам без гарантий от блокировок, продажи рекламодателям или утечек в сеть.
>
> «Турбаза» утверждает новую цифровую парадигму: информация должна принадлежать людям, а суверенитет данных — государству. В этой вводной части подробно рассмотрены истоки идеи, системный тупик облаков и фундаментальный сдвиг, меняющий правила игры.
      ...
      <div class="feature-cards-grid">
        ...
        <div class="feature-card">
          ...
          <div class="feat-points">
            ...
            <div class="feat-point"><strong>Неприкосновенный рубеж:</strong> Семейные секреты должны храниться строго на Листе владельца.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="visual-panel">
      <div class="evolution-billboard-stack">
        ...
        <div class="evolution-step-card step-3">
          ...
          <div class="evolution-step-badge gold">Автономный сейф</div>
        </div>
        ...
        <div class="evolution-step-card step-4">
          <div class="evolution-step-left">
            ...
            <div class="evolution-step-info">
              ...
              <div class="evolution-step-sub">Отечественная среда защищенных вычислений для всей страны и БРИКС</div>
            </div>
          </div>
...
<div class="slide-content">
  <div class="slide-header">
    <div class="explainer-series-marker">🏔️ ПЛАТФОРМА ТУРБАЗА | ПЛАТФОРМЕННЫЙ МОНОПОЛИЗМ</div>
    <h2 class="slide-title">ПЛАТФОРМЕННЫЙ МОНОПОЛИЗМ И ОБЛАЧНАЯ ЗАВИСИМОСТЬ (LOCK-IN)</h2>
    <p class="slide-subtitle">Изолированные силосы данных, потеря истории при смене сервиса и монопольные барьеры</p>
  </div>

  <div class="slide-body grid-2col">
    <div class="glass-card">
      <div class="card-pill-tag gold">СИЛОСНЫЕ БАШНИ СОФТА</div>
      <h3 class="card-title">Данные изолированы в закрытых форматах</h3>
    ...
    <div class="glass-card">
      ...
      <h3 class="card-title">Пользователь в условиях платформенной изоляции</h3>
      ...
      <ul class="card-bullets">
        <li><strong>⛓️ Платформенная зависимость:</strong> Платформы навязывают монопольные правила и диктуют цены.</li>
      ...
      <div class="summary-banner cyan">
        🚨 <strong>Тупик монополизма:</strong> Невозможно развивать суверенную экономику государства на чужих серверах!
      </div>
    </div>
  </div>
</div>
...
### Текст для диктора:
> В классической IT-индустрии доминирует жесткая платформенная монополия.
>
> Традиционные приложения жестко изолируют данные внутри своих закрытых форматов. Вы не можете просто сменить офисную программу или планировщик задач: перенос информации искусственно заблокирован, и при переходе вы теряете годы наработанной истории.
>
> Пользователь оказывается в жесткой зависимости от закрытого внешнего облака. При этом платформенные монополии взимают тридцатипроцентную комиссию с разработчиков, а любой сбой или санкционная блокировка могут в один миг уничтожить архив гражданина или малого предприятия.
  ...
  <div class="slide-body grid-2col">
    <div class="info-panel">
      <div class="key-callout emerald">
        ...
        <p>В «Турбазе» данные физически отделены от приложений. Пользователь полностью владеет собственным Хранилищем данных, а софт является лишь сменным инструментом доступа.</p>
      </div>
      ...
      <div class="data-separation-display">
        <div class="legacy-silos-card">
          <div class="legacy-header">
            <div class="legacy-title">🔴 ТРАДИЦИОННАЯ МОДЕЛЬ: VENDOR LOCK-IN</div>
            <div class="legacy-badge">Привязка данных к софту</div>
          </div>
        ...
        <div class="sovereign-vault-card">
          <div class="vault-centerpiece">
            <div class="vault-badge">🔒 ЕДИНОЕ АВТОНОМНОЕ ХРАНИЛИЩЕ</div>
            <div class="vault-sub">Защищенное хранилище на устройстве гражданина (Лист)</div>
          </div>
...
>
> Ваши заметки, контакты, списки покупок и маршруты хранятся не на серверах разработчиков, а в вашем личном Хранилище на собственном устройстве с полным владением информацией.
>
  ...
  <div class="slide-body grid-2col">
    <div class="glass-card">
      ...
      <ul class="card-bullets">
        ...
        <li><strong>🛡️ Защита семейной информации:</strong> Домашний уклад надежно защищен от утечек и профилирования рекламой.</li>
      </ul>
    ...
    <div class="glass-card">
      ...
      <p class="card-desc">Семейное хранилище объединяет все внешние потоки в целостную ясную картину под прямым контролем семьи.</p>
...
<div class="slide-content">
  ...
  <div class="slide-body grid-2col">
    <div class="glass-card">
      ...
      <h3 class="card-title">Общественная жизнь микрорайона</h3>
    ...
    <div class="glass-card">
      ...
      <ul class="card-bullets">
        ...
        <li><strong>📦 Безопасный постамат:</strong> Доставка в ячейку по одноразовому локальному крипто-токену доступа.</li>
      </ul>
  ...
  <div class="slide-body grid-2col">
    <div class="glass-card">
      ...
      <ul class="card-bullets">
        ...
        <li><strong>🛡️ Иммунитет к ботам:</strong> Каждый голос заверяется аппаратной ЭЦП персонального терминала Лист.</li>
...
<div class="slide-content">
  ...
  <div class="slide-body grid-2col">
    <div class="glass-card">
      ...
      <div class="summary-banner cyan">
        📱 <strong>Инклюзивность:</strong> Передовые технологии владения данными доступны на самых простых смартфонах!
      </div>
    </div>
...
>
> Ответ подтвержден инженерной практикой. Ядро платформы потребляет менее тридцати пяти мегабайт оперативной памяти и работает даже на бюджетных телефонах за пять тысяч рублей.
>
...
<div class="slide-content">
  ...
  <div class="slide-body grid-3col">
    ...
    <div class="glass-card">
      ...
      <h3 class="card-title">Владение данными и ТСО</h3>
    ...
    <div class="visual-panel">
      <div class="glass-card">
        ...
        <div class="summary-banner emerald" style="margin-top: 14px;">
          📈 <strong>Экономический суверенитет страны:</strong> Независимость от иностранного «железа» и облачных монополий!
        </div>
      </div>
    </div>
  </div>
...
<div class="slide-content">
  <div class="slide-header">
    ...
    <h2 class="slide-title">МАНИФЕСТ ВЛАДЕНИЯ ДАННЫМИ И МОСТ К ЧАСТИ 2</h2>
  ...
  <div class="slide-body grid-2col">
    ...
    <div class="glass-card">
      ...
      <p class="card-desc">Во второй части эксплейнер-трилогии подробно рассматривается внутреннее устройство платформы:</p>
      <ul class="card-bullets">
...
### Текст для диктора:
> Подведем итог первой части манифеста платформы.
>
> Здесь показано, что эпоха платформенного монополизма подошла к концу. «Турбаза» возвращает человеку прямое владение собственной информацией, защищает сокровенный мир семьи и закладывает несокрушимый фундамент национального суверенитета государства.
>
> Но как именно эта идея реализована инженерно?
>
> Во второй части подробно рассматривается анатомия платформы: четыре ранга узлов, неделимые Хранилища, реляционные внешние ключи, принцип «Read-Anywhere, Write-Self», древовидная подача данных и микоризный Интернет данных. Спасибо за внимание, переходим ко второй части!
