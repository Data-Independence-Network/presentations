  ...
  <div class="slide-body grid-2col">
    <div class="info-panel">
      ...
      <div class="feature-cards-grid">
        ...
        <div class="feature-card">
          <div class="card-icon">👤</div>
          <h4>ActorId</h4>
          <p><strong>Суверенный субъект:</strong> Триада «Пользователь + Устройство + Приложение» для прав доступа.</p>
        </div>
        <div class="feature-card">
          <div class="card-icon">📄</div>
          <h4>RecordId</h4>
    ...
    <div class="visual-panel">
      <div class="repo-anatomy-diagram">
        <div class="repo-box">
          <div class="repo-box-header">⚡ СУВЕРЕННОЕ ХРАНИЛИЩЕ ДАННЫХ</div>
  ...
  <div class="slide-body grid-2col">
    ...
    <div class="glass-card">
      ...
      <ul class="card-bullets">
        ...
        <li><strong>📜 Суверенная ЭЦП:</strong> Мгновенная генерация юридически значимой подписи без отправки ключа во внешние облака.</li>
      </ul>

      <div class="tee-summary-banner">
        🔒 <strong>Суверенная тайна:</strong> Ваши ключи никогда не покидают кремний пользовательского чипа!
      </div>
    </div>
  </div>
</div>
      ...
      <div class="brics-mycorrhiza-display">
        <div class="mycorrhiza-grid">
          ...
          <div class="mycorrhiza-col bridge">
            ...
            <div class="myco-bridge-desc">Суверенный P2P-клиринг и синхронизация независимых Стволов без SWIFT</div>
    ...
    <div class="visual-panel">
      <div class="glass-card">
        ...
        <ul class="card-bullets">
          ...
          <li><strong>🛡️ Суверенная безопасность:</strong> 0 байт персональных данных в облаках исключает риск массовых атак.</li>
