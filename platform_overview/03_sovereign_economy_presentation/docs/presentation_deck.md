...
>
> Первый — внутренний расчетный контур, предложенный в нашей концепции для Банка России. Это детерминированный конечный автомат Мили над кошельками Цифрового рубля. Он оперирует исключительно балансами, моментально производя списания по математическим формулам. В нём нет персональных данных и тяжелого кода.
>
