...
### Текст для диктора:
> Что же такое смарт-контракт в суверенной парадигме? Это детерминированный механизм состояний над цифровыми кошельками.
>
  ...
  <div class="slide-body grid-2col">
    <div class="info-panel">
      <div class="key-callout teal">
        ...
        <p>Пройден путь от философии суверенного владения данными (Часть 1) и трехзвенной архитектуры шлюзов (Часть 2) к справедливой двухконтурной экономике FSM-контрактов в Цифровом рубле (Часть 3).</p>
      </div>
...
>
> В первой части было обосновано возвращение суверенитета данных гражданам, а во второй — раскрыта анатомия шлюзов, микро-цепей и открытых интерфейсов. В этой презентации представлена завершенная модель справедливой двухконтурной экономики.
>
