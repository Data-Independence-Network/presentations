...
## Цикл из 5 начальных сервисов прикладного контура: «Деловой», «КубГолос», «Забота», «УраТур» и «Локальный реестр МСП и ЖКХ»
...
* **Визуальный стиль:** **«Индустриальный Горизонт» (Industrial Horizon Explainer)**:
  ...
  - Верхний серийный маркер: `🏔️ ПЛАТФОРМА ТУРБАЗА | ПРИКЛАДНЫЕ СЕРВИСЫ`.
...
| :---: | :--- | :--- | :---: | :--- |
| **01** | `01_kubgolos_app_presentation/` | **«КубГолос»: Народные деревья микро-опросов** | Неоновый циан (`#00f0ff` / `#38bdf8`) | *«Голос общества снизу вверх: 6 граней и 3 фактора куба голосования, ветвящиеся деревья вопросов, взвешивание критериев, 0% ботов и децентрализованная агрегация без централизованных баз данных»* (15 слайдов) |
| **02** | `02_zabota_app_presentation/` | **«Забота»: Сеть взаимопомощи и открытая репутация** | Изумрудная хвоя (`#10b981` / `#34d399`) | *«Доверенное добрососедство, подъездная взаимовыручка, очные QR-поручительства соседей, многомерный Web-of-Trust без соцрейтинга и переиспользуемые схемы репутации для форумов»* (15 слайдов) |
| **03** | `03_delovoy_app_presentation/` | **«Деловой»: Органайзер приоритетов и поручений** | Золотой янтарь (`#f59e0b` / `#fbbf24`) | *«Матрица Эйзенхауэра 2.0, гравитационные сферы задач, алгоритм Serendipity против ступора, семейные поручения, внешние ключи и локальный SQLite <1 мс»* (15 слайдов) |
| **04** | `04_uratur_app_presentation/` | **«УраТур»: Автономный туристический планер и путеводитель** | Пурпурный аметист (`#a855f7` / `#e879f9`) | *«Путешествия со смыслом: сборы от „Делового“, народные тропы от „КубГолоса“ и проводники от „Заботы“ — 100% офлайн в горах/тайге по SQLite и ячеистым BLE-сетям»* (15 слайдов) |
...
graph TD
    ...
    classDef app1 fill:#eff6ff,stroke:#3b82f6,stroke-width:1.5px,color:#1e3a8a;
    classDef app2 fill:#f0fdf4,stroke:#22c55e,stroke-width:1.5px,color:#14532d;
    classDef app3 fill:#fefce8,stroke:#eab308,stroke-width:1.5px,color:#713f12;
    ...
    KubGolos["🗳️ «КУБГОЛОС»<br>Деревья микро-опросов"]:::app1
    Zabota["🤝 «ЗАБОТА»<br>Взаимопомощь и репутация"]:::app2
    Delovoy["📋 «ДЕЛОВОЙ»<br>Органайзер дел и поручений"]:::app3
...
├── 01_kubgolos_app_presentation/                # «КубГолос»
│   └── docs/presentation_outline.md
├── 02_zabota_app_presentation/                  # «Забота»
│   └── docs/presentation_outline.md
├── 03_delovoy_app_presentation/                 # «Деловой»
│   └── docs/presentation_outline.md
