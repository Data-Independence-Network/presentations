...
| :---: | :--- | :--- | :---: | :--- |
| **01** | `01_delovoy_app_presentation/` | **«Деловой»: Органайзер приоритетов и поручений** | Золотой янтарь (`#f59e0b` / `#fbbf24`) | *«Матрица Эйзенхауэра 2.0, гравитационные сферы задач, алгоритм Serendipity против ступора, семейные поручения, внешние ключи и локальный SQLite <1 мс»* (15 слайдов) |
| **02** | `02_kubgolos_app_presentation/` | **«КубГолос»: Народные деревья микро-опросов** | Неоновый циан (`#00f0ff` / `#38bdf8`) | *«Голос общества снизу вверх: 6 граней и 3 фактора куба голосования, ветвящиеся деревья вопросов, взвешивание критериев, 0% ботов и децентрализованная агрегация без централизованных баз данных»* (15 слайдов) |
