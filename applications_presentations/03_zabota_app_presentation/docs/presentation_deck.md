...
### Текст для диктора:
> Здравствуйте! В третьей презентации прикладной серии мы представляем платформу «Забота» — автономную систему взаимной поддержки граждан с прямым владением информацией и открытый репутационный стандарт доверия.
>
