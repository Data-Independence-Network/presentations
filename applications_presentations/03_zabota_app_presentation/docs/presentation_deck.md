---
presentation_id: "03_zabota_app_presentation"
...
<div class="slide-content">
  <div class="slide-header">
    ...
    <p class="slide-subtitle">Суверенная платформа добрососедства, взаимной выручки и открытый репутационный стандарт доверия</p>
  </div>
    ...
    <div class="info-panel">
      ...
      <div class="feature-cards-grid">
        ...
        <div class="feature-card">
          ...
          <p>Репутация реальной помощи экспортируется через публичные API.</p>
        </div>
      </div>
    </div>
...
### Текст для диктора:
> Здравствуйте! В третьей презентации прикладной серии мы представляем платформу «Забота» — суверенную систему взаимной поддержки граждан и открытый репутационный стандарт доверия.
>
...
>
> Сущность наследует свойства суверенного класса AirEntity, что обеспечивает автономное хранение на устройстве гражданина и криптографическую защиту от подделки.
>
    ...
    <div class="info-panel">
      ...
      <div class="feature-cards-grid">
        ...
        <div class="feature-card">
          ...
          <p>Один житель — один аргументированный голос в репозитории.</p>
        </div>
      </div>
    </div>
...
### Текст для диктора:
> Важнейший вклад проекта «Забота» в суверенную ИТ-инфраструктуру — это создание открытого реляционного стандарта данных для взаимопомощи и социального взаимодействия.
>
...
>
> Наша репутационная модель строго контекстна и защищена криптографией. Если мастер великолепно чинит электропроводку в домах района, он зарабатывает авторитет проверенного электрика.
>
...
### Текст для диктора:
> Подлинная мощь суверенной платформы проявляется в бесшовной синергии её флагманских приложений.
>
...
<div class="slide-content">
  <div class="slide-header">
    ...
    <p class="slide-subtitle">«Забота» возвращает людям тепло общения, безопасность двора и технологический суверенитет</p>
  </div>
    ...
    <div class="visual-panel">
      <div class="kpi-vertical-stack">
        ...
        <div class="kpi-card-explainer">
          ...
          <div class="kpi-label">Суверенная цифровая среда для каждого двора</div>
        </div>
      </div>
    </div>
  </div>
...
>
> Опираясь на суверенную архитектуру Турбазы, «Забота» доказывает, что технологии могут служить не слежке и рекламе, а объединению людей, защите старшего поколения и поддержке семей.
>
> Спасибо за внимание! В следующей презентации мы покажем, как эти принципы открывают новые горизонты в путеводителе путешествий «УраТур».
