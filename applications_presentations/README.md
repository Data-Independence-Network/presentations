...
1. **«Деловой»** — персональный и семейный органайзер приоритетов, задач и поручений.
2. **«КубГолос»** — народная платформа версионных микро-опросов «снизу вверх» и коллективного разума.
