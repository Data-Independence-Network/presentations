...
## 🎯 Purpose & Scope
This directory hosts the presentation suite for the **Flagship Core Applications of the «Турбаза» Ecosystem**:
...
├── turbase_applications_master_plan.md          # Series Master Architecture Plan
