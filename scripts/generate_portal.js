...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Controls bar should NEVER be sticky on mobile, tablet, or short-height viewports */
    ...
    @media (orientation: landscape) and (max-height: 560px) {
      .container { padding: 14px 20px 50px; }
      .hero-header { padding: 12px 0 14px; margin-bottom: 16px; }
      .hero-top { margin-bottom: 8px; gap: 10px; }
      .hero-title { font-size: 26px !important; line-height: 1.2 !important; margin-bottom: 6px; }
      .hero-subtitle { font-size: 14px !important; line-height: 1.4 !important; }
      .stats-row { margin-top: 14px !important; gap: 10px !important; grid-template-columns: repeat(2, 1fr) !important; }
      ...
      .controls-top { gap: 10px; }
      .mode-tab { padding: 7px 12px !important; font-size: 13px !important; }
      .search-input { padding: 8px 12px 8px 36px !important; font-size: 13.5px !important; }
      .filter-tags-row { gap: 6px !important; }
      .filter-tag-pill { padding: 6px 12px !important; font-size: 12px !important; }
      .category-header { margin-bottom: 14px !important; }
      ...
      .pres-card { padding: 18px !important; }
    ...
    @media (max-width: 900px) {
      ...
      .controls-bar { position: static !important; }
