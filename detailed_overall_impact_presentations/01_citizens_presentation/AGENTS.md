# AGENTS.md — 01_citizens_presentation

## 🎯 Purpose & Scope
Contains presentation materials, slides, web deck, audio tracks, and automated build pipelines for **Presentation 01: Турбаза для Граждан и Домохозяйств: Владение собственной информацией и абсолютная защита личной жизни** (15 billboard slides).

---

## 🧭 Architectural Focus & Key Concepts
- **Focus:** Неприкосновенность личной жизни, 0 байт персональных данных у третьих лиц, владение фото, переписками и документами на личном устройстве, надежное социальное восстановление Shamir Secret Sharing.
...
- **Target Audience:** Граждане РФ, семьи, домохозяйства, правозащитники приватности.
- **Narrative Style:** Доверительный, защищающий, доступный и убедительный тон (`ru-RU-DmitryNeural`, rate -9%, pitch -5Hz).
...
```bash
# Offline rebuild:
npm --prefix detailed_overall_impact_presentations run rebuild-01
node rebuild.js

# Full regeneration with Neural TTS:
npm --prefix detailed_overall_impact_presentations run regen-01
node regenerate.js
```
