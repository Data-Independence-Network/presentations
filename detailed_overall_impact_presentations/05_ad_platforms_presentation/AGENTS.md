# AGENTS.md — 05_ad_platforms_presentation

## 🎯 Purpose & Scope
Contains presentation materials, slides, web deck, audio tracks, and automated build pipelines for **Presentation 05: Турбаза для Рекламных Платформ и AdTech: Федеративная дистрибуция, ликвидация клик-фрода и -80% серверных затрат** (15 billboard slides).
...
- **Focus:** Федеративная дистрибуция рекламного инвентаря, ликвидация тяжелых серверов сбора кликстрима, мгновенный ZK-клиринг показов, снижение серверных затрат AdTech сетей на 80%.
...
- **Target Audience:** Технические директора рекламных сетей (CTO AdTech), DSP/SSP операторы, аналитики трафика.
- **Narrative Style:** Высокотехнологичный, структурный, AdTech-ориентированный тон (`ru-RU-DmitryNeural`, rate -9%, pitch -5Hz).
...
```bash
# Offline rebuild:
npm --prefix detailed_overall_impact_presentations run rebuild-05
node rebuild.js

# Full regeneration with Neural TTS:
npm --prefix detailed_overall_impact_presentations run regen-05
node regenerate.js
```
